...
<link rel="stylesheet" type="text/css" href="<?php echo SITE_URL;?>/css/css.css?v=20150617">
<script type="text/javascript" src="<?php echo SITE_URL;?>/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo SITE_URL;?>/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo SITE_URL;?>/js/wap.lazy.min.js"></script>
<script type="text/javascript" src="<?php echo SITE_URL;?>/js/jquery.cookie.js"></script>
<script type="text/javascript" src="<?php echo SITE_URL;?>/js/wap_v4_common.js"></script>
